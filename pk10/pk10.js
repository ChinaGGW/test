...
! function(ca) {
	...
	function ha(e) {
		function i(e, t, i) {
			var n, r, o, a, s, u, c, d = t && t.split("/");
			r = d;
			var f = T.map,
				p = f && f["*"];
			if(e && "." === e.charAt(0))
				if(t) {
					for(r = d.slice(0, d.length - 1), e = e.split("/"), t = e.length - 1, T.nodeIdCompat && R.test(e[t]) && (e[t] = e[t].replace(R, "")), r = e = r.concat(e), a = r.length, t = 0; t < a; t++)
						if("." === (o = r[t])) r.splice(t, 1), t -= 1;
						else if(".." === o) {
						if(1 === t && (".." === r[2] || ".." === r[0])) break;
						0 < t && (r.splice(t - 1, 2), t -= 2)
					}
					e = e.join("/")
			...
			if(i && f && (d || p)) {
				...
				e: for(; 0 < t; t -= 1) {
					if(a = r.slice(0, t).join("/"), d)
						for(o = d.length; 0 < o; o -= 1)
							if((i = j(f, d.slice(0, o).join("/"))) && (i = j(i, a))) {
								n = i, s = t;
								break e
							}!u && p && j(p, a) && (u = j(p, a), c = t)
				}!n && u && (n = u, s = c), n && (r.splice(0, s, n), e = r.join("/"))
			}
		...
		function n(e) {
			z && v(document.getElementsByTagName("script"), function(t) {
				if(t.getAttribute("data-requiremodule") === e && t.getAttribute("data-requirecontext") === E.contextName) return t.parentNode.removeChild(t), !0
			})
		}

		function r(e) {
			var t = j(T.paths, e);
			if(t && H(t) && 1 < t.length) return t.shift(), E.require.undef(e), E.require([e]), !0
		}
		...
		function a(e, t, n, r) {
			var a, s, u = null,
				...
				f = !0,
				p = "";
			return e || (f = !1, e = "_@r" + (Q += 1)), e = o(e), u = e[0], e = e[1], u && (u = i(u, c, r), s = j(A, u)), e && (u ? p = s && s.normalize ? s.normalize(e, function(e) {
				return i(e, c, r)
			}) : i(e, c, r) : (p = i(e, c, r), e = o(p), u = e[0], p = e[1], n = !0, a = E.nameToUrl(p))), n = !u || s || n ? "" : "_unnormalized" + ($ += 1), {
				prefix: u,
				name: p,
				parentMap: t,
				unnormalized: !!n,
		...
		function m() {
			...
			if(!q) {
				if(q = !0, B(w, function(e) {
					...
					}), i && o.length) return e = C("timeout", "Load timeout for modules: " + o, null, o), e.contextName = E.contextName, d(e);
				u && v(a, function(e) {
					l(e, {}, {})
		...
		function b() {
			var e;
			for(f(); N.length;) {
				if(e = N.shift(), null === e[0]) return d(C("mismatch", "Mismatched anonymous define() module: " + e[e.length - 1]));
				g(e)
			}
		}
		var q, y, E, k, M, T = {
		...
		return k = {
			...
			exports: function(e) {
				if(e.usingExports = !0, e.map.isDefine) return e.exports ? A[e.map.id] = e.exports : e.exports = A[e.map.id] = {}
			},
			module: function(e) {
						...
						if(this.error) this.emit("error", this.error);
							...
							if(this.defining = !0, 1 > this.depCount && !this.defined) {
								if(G(r)) {
									...
									if(this.map.isDefine && void 0 === n && ((t = this.module) ? n = t.exports : this.usingExports && (n = this.exports)), e) return e.requireMap = this.map, e.requireModules = this.map.isDefine ? [this.map.id] : null, e.requireType = this.map.isDefine ? "define" : "require", d(this.error = e)
								} else n = r;
			...
			callPlugin: function() {
				var e = this.map,
					n = e.id,
					r = a(e.prefix);
				this.depMaps.push(r), c(r, "defined", t(this, function(r) {
					var o, f;
					f = j(_, this.map.id);
					var l = this.map.name,
					...
					this.map.unnormalized ? (r.normalize && (l = r.normalize(l, function(e) {
						return i(e, m, !0)
					}) || ""), r = a(e.prefix + "!" + l, this.map.parentMap), c(r, "defined", t(this, function(e) {
						this.init([], function() {
							return e
						}, null, {
							enabled: !0,
						...
						var r = e.name,
							c = a(r),
							f = O;
						i && (t = i), f && (O = !1), u(c), s(T.config, n) && (T.config[r] = T.config[n]);
						try {
							h.exec(t)
						} catch(e) {
							return d(C("fromtexteval", "fromText eval for " + n + " failed: " + e, e, [n]))
						}
						f && (O = !0), this.depMaps.push(c), E.completeLoad(r), g([r], o)
					}), r.load(e.name, g, o, T))
			...
			enable: function() {
				w[this.map.id] = this, this.enabling = this.enabled = !0, v(this.depMaps, t(this, function(e, i) {
					...
					if("string" == typeof e) {
						...
						this.depCount += 1, c(e, "defined", t(this, function(e) {
			...
			makeRequire: function(t, r) {
				function o(i, n, c) {
					var f, p;
					return r.enableBuildCallback && n && G(n) && (n.__requireJsBuild = !0), "string" == typeof i ? G(n) ? d(C("requireargs", "Invalid require call"), c) : t && s(k, i) ? k[i](D[t.id]) : h.get ? h.get(E, i, t, o) : (f = a(i, t, !1, !0), f = f.id, s(A, f) ? A[f] : d(C("notloaded", 'Module name "' + f + '" has not been loaded yet for context: ' + e + (t ? "" : ". Use require([])")))) : (b(), E.nextTick(function() {
						b(), p = u(a(null, t)), p.skipMap = r.skipMap, p.init(i, n, c, {
							enabled: !0
						}), m()
					}), o)
				}
				return r = r || {}, V(o, {
					...
					toUrl: function(e) {
						var n, r = e.lastIndexOf("."),
							o = e.split("/")[0];
						return -1 !== r && ("." !== o && ".." !== o || 1 < r) && (n = e.substring(r, e.length), e = e.substring(0, r)), E.nameToUrl(i(e, t && t.id, !0), n, !0)
					},
					defined: function(e) {
			...
			completeLoad: function(e) {
				...
				if(i = j(D, e), !t && !s(A, e) && i && !i.inited) {
					if(T.enforceDefine && (!o || !ea(o))) return r(e) ? void 0 : d(C("nodefine", "No define call for " + e, null, [e]));
			...
			nameToUrl: function(e, t, i) {
				...
				if(h.jsExtRegExp.test(e)) n = e + (t || "");
					...
					for(n = T.paths, e = e.split("/"), r = e.length; 0 < r; r -= 1)
			...
			onScriptError: function(e) {
				var t = x(e);
				if(!r(t.id)) return d(C("scripterror", "Script error for: " + t.id, e, [t.id]))
			}
	...
	if(void 0 === define) {
		...
		void 0 !== require && !G(require) && (r = require, require = void 0), h = requirejs = function(e, t, i, n) {
			var r, o = "_";
			...
			var n, r;
			"string" != typeof e && (i = t, t = e, e = null), H(t) || (i = t, t = null), !t && G(i) && (t = [], i.length && (i.toString().replace(/(\/\*([\s\S]*?)\*\/|([^:]|^)\/\/(.*)$)/gm, "").replace(/[^.]\s*require\s*\(\s*["']([^'"\s]+)["']\s*\)/g, function(e, i) {
				t.push(i)
